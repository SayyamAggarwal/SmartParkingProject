...
class Add_ParkingPlaza:
    def __init__(self):
        ...
        self.mainLabel = tkinter.Label(self.root,text='MONTHLY PASS',fg=self.framebackground,font=('Helvetica 12 bold',16,'bold'))
    ...
    def AddParkingPlaza(self):
            ...
            q = f"insert into monthly_pass values (null,'{category_name}','{price}','{description}')"
            self.cr.execute(q)
            self.conn.commit()
